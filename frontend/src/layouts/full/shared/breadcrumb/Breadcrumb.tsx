...
const Breadcrumb = ({ subtitle, items, title, children, background, color }: BreadCrumbType) => (
  <Grid
    container
    sx={{
      backgroundColor: background ? background : 'primary.light',
  ...
  >
    ...
    <Typography variant="h4">{title}</Typography>
      <Typography color={color ? color : 'textSecondary'} variant="h6" fontWeight={400} mt={0.8} mb={0}>
        {subtitle}
      </Typography>
      <Breadcrumbs
        separator={
